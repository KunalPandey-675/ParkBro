      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <select
            ...
            className="w-full md:w-1/3 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          >
        ...
        >
          ...
          <div className="flex justify-center space-x-8 mt-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-600">AI Predicted Price</span>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-md p-6 mb-8"
        >
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Demand Forecast</h2>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={pricingData}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="time" />
        ...
        >
          ...
          <button className="mt-6 bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition font-semibold">
            Update Pricing
          </button>
        </motion.div>
      </div>
